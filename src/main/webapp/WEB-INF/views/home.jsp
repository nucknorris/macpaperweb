...
<body>
	<div class="container">
		<div id="header" class="prepend-1 span-22 append-1 last">
			<h1 class="loud">Welcome to Spring Integration</h1>
			<div>
				<form:form id="formId">
					<input id="startTwitter" type="submit" name="startTwitter"
						value="Start Twitter Search" /> |
                        <input id="stopTwitter" type="submit"
						name="stopTwitter" value="Stop Twitter Search" />
				</form:form>
			</div>
		</div>
