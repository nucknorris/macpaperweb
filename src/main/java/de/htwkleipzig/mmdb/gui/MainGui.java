...
public class MainGui extends Application {
	...
	public void init() {
		 ...
		 */
		Button upload = new Button("Upload a new file",
		...
		/*
		 * Button to open the dialog that lists all documents in the directory
		 * /tmp/uploads
		 */
		Button listDocuments = new Button("List documents",
				new Button.ClickListener() {
					public void buttonClick(ClickEvent event) {
		 ...
		 */
		Button search = new Button("fulltext search",
				new Button.ClickListener() {
