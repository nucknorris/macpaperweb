...
public class Paper implements Serializable {
	...
	public String toString() {
		...
		builder.append("Paper [title=").append(title).append(", authors=")
				.append(authorsId).append(", createDate=").append(createDate)
				.append(", keywords=").append(keywords).append(", kindOf=")
				.append(kindOf).append("]");
