...
public class HomeController {
	...
	public static final String PAPERINDEX = "paperindex";
	...
	public String elasticbean(@RequestParam(required = true) String id,
			Model model) {

		GetResponse rsp = elasticService.get(HomeController.PAPERINDEX,
				HomeController.INDEXTYPE, id);
	...
	public String elasticsearch(
		...
		QueryStringQueryBuilder qb = QueryBuilders.queryString(searchPhrase)
	...
	public String elasticsave(@RequestParam(required = true) String path,
		...
		elasticService.save(HomeController.PAPERINDEX,
				HomeController.INDEXTYPE, id, test);
		logger.debug("saved");
		return "elastic";
	}
